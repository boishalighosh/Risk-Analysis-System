...
<body>
    ...
    <header class="nav">
        ...
        <div class="menu" id="menu">
            ...
            <div class="logout">
                <a href="logouta.php"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
            </div>
        </div>
    </header>
    <div class="container" id="container">
        <div class="item">
            ...
            <div class="detail">Employee Registration</div>
            </a>
        </div>
        <div class="item">
            <a href="emp.php">
            <div class="icon"><i class="fa fa-file-text-o"></i></div>
            <div class="detail">Employee Details</div>
            </a>
        </div>
        <div class="item">
            <a href="plana.php">
        ...
        <div class="item">
            ...
            <div class="detail">Risk Analysis</div>
            </a>
        </div>
        <div class="item">
            <a href="#">
